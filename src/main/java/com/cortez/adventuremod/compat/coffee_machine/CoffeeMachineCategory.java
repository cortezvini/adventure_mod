...
public class CoffeeMachineCategory implements DisplayCategory<BasicDisplay> {
    public static final Identifier TEXTURE =
            new Identifier(AdventureMod.MODID, "textures/gui/coffee_machine_gui.png");
    public static final CategoryIdentifier<CoffeeMachineDisplay> COFFEE_MACHINE =
            CategoryIdentifier.of(AdventureMod.MODID, "coffee_machine");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.COFFEE_MACHINE.asItem().getDefaultStack());
    }
